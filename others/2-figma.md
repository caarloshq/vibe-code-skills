...
name: 2-figma
description: >
  Executa o plano de design no Figma via MCP. Use depois do 1-plan-design, quando o usuário
...
Cria os frames no Figma com base no plano gerado pelo `1-plan-design`.
...
> "Não encontrei estilos na página atual. Quer que eu use os tokens padrão da AmFi ou prefere importar os estilos antes de continuar?"
...
Criar os frames na ordem definida no plano do `1-plan-design`.
...
> "Frames prontos. Para validar antes do handoff, inicie uma nova conversa e rode `3-review` — ele compara o que foi criado com o plano e a task original, e passa pelas heurísticas de usabilidade."
